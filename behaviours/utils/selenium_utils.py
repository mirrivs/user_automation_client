...
from behaviours.utils.email_web_client import EmailClientUser, O365Client, OutlookWebAccessClient, RoundcubeClient, getEmailClient
...
class SeleniumController(SeleniumDriver):
    def __init__(self, driver: webdriver, email_client_type: EmailClient, user: EmailClientUser):
        ...
        self.email_client: (OutlookWebAccessClient | RoundcubeClient | O365Client) = getEmailClient(email_client_type)(driver, user)
